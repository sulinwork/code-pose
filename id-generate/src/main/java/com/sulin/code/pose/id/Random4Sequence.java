 ...
 * 没问题
 */
public class Random4Sequence implements Sequence {
    ...
    public Random4Sequence(int bufferSize, int factor) {
        ...
        for (; ; ) {
            ...
            if (Objects.nonNull(element)) {
                if (randomBufferRef.compareAndSet(curBuffer, curBuffer)) {
                    ...
                    return curBuffer.getNodeId() + StringUtils.leftPad(String.valueOf(element), factor, "0");
                } else {
                    continue;
                }
            }
