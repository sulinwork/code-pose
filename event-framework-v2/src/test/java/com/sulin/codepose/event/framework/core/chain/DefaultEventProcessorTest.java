...
//
//        private TestChain(DomainEventHandler<DomainEvent, ?>... handlers) {
...
//    }
//
//    private abstract static class BaseHandler implements DomainEventHandler<DomainEvent, TestPayload> {
//
...
//    }
//
//    private static final class DelayedHandler extends BaseHandler implements DelayableEventHandler<DomainEvent, TestPayload> {
//
...
//    }
//
//    private static final class GroupHandler extends BaseHandler implements GroupedEventHandler<DomainEvent, TestPayload> {
//
...
//
//        @Override
//        public List<DomainEventHandler<DomainEvent, TestPayload>> subHandlers() {
//            return Collections.singletonList(new GroupSubHandler());
//        }
//    }
//
